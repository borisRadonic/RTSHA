...
/* Configure the peripherals common clocks */
  ...
  /*288K of RAM_D2 started at address 0x30000000 will be used as RTSHA heap storage*/
  ...
  if( true == rtsha_create_heap( (void*) _RTSHA_HeapStart, _RTSHA_HeapSize ) )
  {
	  ...
	  /*small 16K page for buffers smaller than 32bytes, with maximum*/
	  heapOk = heapOk | rtsha_add_page( &callbacks, RTSHA_PAGE_TYPE_32, 16384U);

	  /*small 16K page for buffers between 32 and 64 bytes*/
